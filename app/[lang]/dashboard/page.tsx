...
function DashboardContent({ lang }: { lang: "fa" | "en" }) {
  ...
  useEffect(() => {
    localStorage.setItem("prm_lang", lang);
...
export default function DashboardPage({ params }: { params: Promise<{ lang: "fa" | "en" }> }) {
  const resolvedParams = use(params);
  return (
    <NotificationProvider>
      <DashboardContent lang={resolvedParams.lang} />
    </NotificationProvider>
  );
}
